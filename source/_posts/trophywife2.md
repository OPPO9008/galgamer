...
<div class="row bg-dark sp-character" style=%{ $shadow: shadow }%>
  <div class={`col-md-${md} col-lg-${lg}`}>
    <img class="bg-transparent img-fluid" src={`../image/trophywife2/chars/${no}.webp`} />
  </div>
  <div class="col-lg-7 col-md-11">
    <div class="row row-cols-1">
      <img class="col bg-transparent border-danger my-2" src={`../image/trophywife2/chars/${no}name.webp`} style="max-width:250px" />
...
五年前嫁给了人气演员高峰東彌。
一方面，女主角對心愛的丈夫言聽計從，感情甚篤
另一方面，卻因爲對丈夫忙碌的不滿和内心抖M的願望
開始沉溺於在便利店竊取一些價值不大的物件
而這一切全部被男主角在暗中窺見......
</sp-character>
...
本游戲俺を見下すセレブ妻のドM願望 新感覚アニメーションノベル妻缶2」由「ANIMovie」製作，在2021年6月25日正式發售。
