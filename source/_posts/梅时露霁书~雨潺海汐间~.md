...
{% custom_element dialog-list html %}
<div class="sp-dialog-list">
  {html.split(/ *\| */).filter(x=>x).map(line => <div class=%{ spDialog: true,
...
{% custom_element sp-character no name append cv ident html %}
...
{% custom_element sp-intro title html %}{
